...
{
	if (const bool bIsEnemy = Target->ActorHasTag(FName("Enemy")); bIsEnemy && !bApplyEffectsToEnemies)
		return;
...
{
	if (const bool bIsEnemy = TargetActor->ActorHasTag(FName("Enemy")); bIsEnemy && !bApplyEffectsToEnemies)
		return;
